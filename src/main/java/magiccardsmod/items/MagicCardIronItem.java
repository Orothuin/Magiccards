...
public class MagicCardIronItem extends Item {

	public MagicCardIronItem() {
	...
	public AbstractCardEntity getProjectileEntity(World worldIn, PlayerEntity playerIn, ItemStack thrownCard) {
		...
		return new MagicCardIronEntity(worldIn, playerIn, thrownCard);
	}

	@Override
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {

		float dmg = (MagicCardIronEntity.DEFAULT_DAMAGE + getEnchExtraDamage(stack));
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		if (!worldIn.isRemote) {
			...
			entity.shoot(playerIn, playerIn.rotationPitch, playerIn.rotationYaw, 0.0F, 1.9F, 1.0F);
