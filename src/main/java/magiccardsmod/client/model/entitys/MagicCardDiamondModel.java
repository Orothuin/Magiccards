...
@OnlyIn(Dist.CLIENT)
public class MagicCardDiamondModel extends EntityModel<MagicCardDiamondEntity> {
	...
	public MagicCardDiamondModel() {
		...
		bone6.cubeList.add(new ModelBox(bone6, 0, 0, -2.25F, -1.25F, 1.0F, 2, 1, 1, 0.0F, false));
		bone6.cubeList.add(new ModelBox(bone6, 0, 5, -1.0F, -1.25F, -0.25F, 1, 1, 2, 0.0F, false));

		bone7 = new RendererModel(this);
		bone7.setRotationPoint(-3.0833F, -0.8333F, -4.6667F);
		bone.addChild(bone7);
		setRotationAngle(bone7, 0.0F, 180.0F, 0.0F);
		bone7.cubeList.add(new ModelBox(bone7, 0, 0, -1.25F, -0.25F, 0.25F, 2, 1, 1, 0.0F, false));
		bone7.cubeList.add(new ModelBox(bone7, 0, 5, 0.0F, -0.25F, -1.0F, 1, 1, 2, 0.0F, false));

		bone5 = new RendererModel(this);
		bone5.setRotationPoint(3.4167F, 0.1667F, 2.5833F);
		bone.addChild(bone5);
		bone5.cubeList.add(new ModelBox(bone5, 0, 0, -2.25F, -1.25F, 1.0F, 2, 1, 1, 0.0F, false));
		bone5.cubeList.add(new ModelBox(bone5, 0, 5, -1.0F, -1.25F, -0.25F, 1, 1, 2, 0.0F, false));

		bone2 = new RendererModel(this);
		bone2.setRotationPoint(-2.8333F, -0.8333F, 3.5833F);
		bone.addChild(bone2);
		setRotationAngle(bone2, 0.0F, -90.0F, 0.0F);
		bone2.cubeList.add(new ModelBox(bone2, 0, 0, -1.25F, -0.25F, 0.25F, 2, 1, 1, 0.0F, false));
		bone2.cubeList.add(new ModelBox(bone2, 0, 5, 0.0F, -0.25F, -1.0F, 1, 1, 2, 0.0F, false));
	}

	@Override
	public void render(MagicCardDiamondEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		bone.render(f5);
